#ifndef CONFIG_H_
#define CONFIG_H_
//  =======================  modified by Huang ChunSheng (SZHCS@QQ.COM) V1.0 for CRIUS SE V2.5 mini board ==================================================
/*************************************************************************************************/
...
/*************************************************************************************************/
  ...
  /**************************    The type of multicopter    ****************************/
    ...
    //#define TRI
    //#define QUADP
    #define QUADX                                                            // Type of my copter =======================================================
    //#define Y4
    //#define Y6
    //#define HEX6
    //#define HEX6X
  ...
  /****************************    Motor minthrottle    *******************************/
    ...
    #define MINTHROTTLE 1210 // (*) (**)                                       // notice ****************************************************************         
  ...
  /**********************************    I2C speed   ************************************/
  //#define I2C_SPEED 100000L     //100kHz normal mode, this value must be used for a genuine WMP        // Source is uncomment  ------------------------
  #define I2C_SPEED 400000L   //400kHz fast mode, it works only with some WMP clones                 // CRIUS V2.5 can do it =========================
  ...
  /**************************************************************************************/
    ...
    /***************************    Combined IMU Boards    ********************************/
      ...
      //#define FREEIMUv035_BMP // FreeIMU v0.3.5_BMP                                                    // CRIUS SE 1.0 activate it ********************
      ...
      #define HK_MultiWii_SE_V2  // Hobbyking board with MPU6050 + HMC5883L + BMP085       // CRIUS SE V2.0 & V2.5 activate it  =========================
...
/*************************************************************************************************/
  ...
  /***********************          Cam Stabilisation             ***********************/
    ...
    #define SERVO_TILT                                                             // I like gimbal =====================================================
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /**************************    Hexa Motor 5 & 6 Pins    *******************************/
      ...
      //#define A0_A1_PIN_HEX                                                  // notice ****************************************************************

    /*********************************    Aux 2 Pin     ***********************************/
      /* possibility to use PIN8 or PIN12 as the AUX2 RC input (only one, not both)
         it deactivates in this case the POWER PIN (pin 12) or the BUZZER PIN (pin 8) */
      #define RCAUXPIN8                                                      // To use AUX2 =============================================================
      //#define RCAUXPIN12
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /*********************    Lowpass filter for some gyros    ****************************/
      ...
      //#define MPU6050_LPF_188HZ                                                          // notice ***************************************************
 ...
 */
  ...
  /**************************************************************************************/
    ...
    #define DEADBAND 5                                      // source is 6 and comment ==========================================================
  ...
  /**************************************************************************************/
   ...
   #define I2C_GPS_SONAR
    ...
    #define MAG_DECLINATION  -6.1f   //(**)                                //For beijing ================================================================
  ...
  /********************************************************************/
    ...
    #define VBATLEVEL_WARN1 105 // (*) (**) 3.5V/cell              107/99/93           // =============================================================
    #define VBATLEVEL_WARN2 102 // (*) (**) 3.4V/cell                               // =============================================================
    #define VBATLEVEL_CRIT   99 // (*) (**) 3.3V/cell - critical condition: if vbat ever goes below this value, permanent alarm is triggered  // =============================================================
...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    //#define EXT_MOTOR_RANGE // using this with wii-esc requires to change MINCOMMAND to 1008 for promini and mega
                                                                   //Notice: SkyWalker refresh rate:50-432Hz ******************************************
  /**************************************************************************************/
  /***********************     motor, servo and other presets     ***********************/
  /**************************************************************************************/
    /* motors will not spin when the throttle command is in low position
       this is an alternative method to stop immediately the motors */
    //#define MOTOR_STOP                                                               //Notice: ******************************************************
